    ...
    <ul class="sidebar-menu" >
      ...
      <li class="with-sub <?php if (Auth::user()->isAdmin == '1'): ?>
        ...
        <ul>
          ...
          <li><a href="<?php echo e(route('softStudentList')); ?>">لیست محصلین  انجنیری نرم افزار</a></li>
          <li><a href="<?php echo e(route('itStudentList')); ?>">لیست محصلین  تکنالوژی معلوماتی</a></li>
          <li><a href="<?php echo e(route('blockList')); ?>">محصلین  غیر برحال</a></li>
        </ul>
      </li>
