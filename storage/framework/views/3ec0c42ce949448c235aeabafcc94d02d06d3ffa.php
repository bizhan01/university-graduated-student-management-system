	...
	<div class="container-fluid">
		...
		<div class="box box-block bg-white">
			<div class="overflow-x-auto">
				<table class="table table-striped table-bordered dataTable" id="table-3">
					...
					<tbody>
						<?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php echo e($application->gender); ?> <?php echo e($application->name); ?> <?php echo e($application->lastName); ?></td>
                ...
                <td>
                  <a href="<?php echo e(url('deleteApplication').'/' .$application->id); ?>" title="لغو درخواست" onclick='return confirm("آیا مطمین استید درخواست شما لغو شود؟")'>
