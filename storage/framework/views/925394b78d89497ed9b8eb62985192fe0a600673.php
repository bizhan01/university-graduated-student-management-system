...
<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('../vendors/starability/css/starability-all.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../css/ratings.css')); ?>">
