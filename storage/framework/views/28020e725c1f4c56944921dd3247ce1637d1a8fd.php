...
<div class="content-area py-1">
	<div class="container-fluid">
		...
		<div class="box box-block bg-white" style="margin-top: -35px">
			 <form method="POST" action="<?php echo e(route('addJob')); ?>" enctype="multipart/form-data">
                    ...
                    <td>
											...
											<div class="nav-item dropdown" dir="ltr" style="margin-left: 10px; margin-bottom: -25px">
												...
												<div class="dropdown-menu dropdown-menu-right animated flipInY">
													<a class="dropdown-item" href="editeJob/<?php echo e($job->id); ?>" style="color: green">
														بروزرسانی
														<i class="ti-pencil mr-0-5"></i>
													</a>
													<a class="dropdown-item" href="deleteJob/<?php echo e($job->id); ?>" style="color: red" onclick='return confirm("آیا مطمین استید حذف شود؟")'>
														حذف
