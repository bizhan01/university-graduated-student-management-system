					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="<?php echo $user[0]->name; ?>" required autofocus required placeholder="اسم کامل کاربر">
							</div>
						</div>
						...
						<div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="<?php echo $user[0]->email; ?>" required required placeholder="someone@domain.com">
								</div>
							</div>
